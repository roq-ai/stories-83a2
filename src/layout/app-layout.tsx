...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiBook, FiBookOpen } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'editor', 'writer', 'administrator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Story', path: '/stories', entity: 'story', service: AccessServiceEnum.PROJECT, icon: FiBook },
